...
const pathsStrokes = ["M289.398 394.137H559.404", "M559.182 394.137V371.289"];

const pathsFills = [
  {
    path: "M289.473 397.486H286.724V390.713H289.473V397.486Z",
    colour: "fill-white",
  },
  {
    path: "M560.519 397.486H557.77V390.713H560.519V397.486Z",
    colour: "fill-white",
  },
  {
    path: "M560.668 370.173C560.668 371.364 559.702 372.331 558.513 372.331C557.325 372.331 556.359 371.364 556.359 370.173C556.359 368.982 557.325 368.015 558.513 368.015C559.702 368.015 560.668 368.982 560.668 370.173Z",
    colour: "fill-white",
  },
  {
    path: "M454.791 406.937H351.737V403.96H454.791V406.937Z",
    colour: "fill-graphicLightRed",
  },
  {
    path: "M299.355 418.77H309.534L310.871 415.868H290.29V420.631H297.497L299.355 418.77Z",
    colour: "fill-graphicLightRed",
  },
];
